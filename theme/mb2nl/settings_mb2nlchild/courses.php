...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startcourse', get_string('coursesettings', 'theme_mb2nl'));
$temp->add($setting);
    ...
    $name = 'theme_mb2nlchild/fsmoddh';
    $title = get_string('fsmodheaderdark', 'theme_mb2nl');
    $setting = new admin_setting_configcheckbox($name, $title, '', 1);
    $temp->add($setting);

    $name = 'theme_mb2nlchild/fsmodnav';
    $title = get_string('fsmodnav', 'theme_mb2nl');
    $setting = new admin_setting_configcheckbox($name, $title, '', 0);
    $temp->add($setting);

    $name = 'theme_mb2nlchild/coursespacer15';
    ...
    $name = 'theme_mb2nlchild/coursetocnomod';
    $title = get_string('coursetocnomod', 'theme_mb2nl');
    $setting = new admin_setting_configcheckbox($name, $title, '', 0);
    $temp->add($setting);

    $name = 'theme_mb2nlchild/coursespacer16';
    $setting = new admin_setting_configmb2spacer($name);
    $temp->add($setting);

    $name = 'theme_mb2nlchild/cupdatedate';
    ...
    $temp->add(new admin_setting_configmb2spacer('theme_mb2nlchild/coursespacer17'));
    ...
    $name = 'theme_mb2nlchild/pricesep';
    ...
    $setting = new admin_setting_configmb2start2('theme_mb2nlchild/startcourselist', get_string('courseslist', 'theme_mb2nl'));
    $temp->add($setting);
    ...
    $name = 'theme_mb2nlchild/crounded';
    $title = get_string('crounded', 'theme_mb2nl');
    $setting = new admin_setting_configcheckbox($name, $title, '', 1);
    $temp->add($setting);

    $name = 'theme_mb2nlchild/filterpos';
    ...
    $temp->add(new admin_setting_configmb2spacer('theme_mb2nlchild/coursespacer5'));

    $name = 'theme_mb2nlchild/ccimgs';
    ...
    $name = 'theme_mb2nlchild/filterfields';
    ...
    $setting = new admin_setting_configmb2start2('theme_mb2nlchild/startcoursepage', get_string('coursepage', 'theme_mb2nl'));
    $temp->add($setting);
    ...
    $name = 'theme_mb2nlchild/cpcatcolor';
    ...
    $setting = new admin_setting_configmb2start2('theme_mb2nlchild/startenrolmentpage',
    get_string('enrollmentpage', 'theme_mb2nl'));
    $temp->add($setting);
    ...
    $name = 'theme_mb2nlchild/cecatcolor';
    $title = get_string('catcolor', 'theme_mb2nl');
    $setting = new admin_setting_configcheckbox($name, $title, '', 0);
    $temp->add($setting);
