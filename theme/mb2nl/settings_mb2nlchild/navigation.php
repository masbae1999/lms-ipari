...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startnavgeneral', get_string('mainmenu', 'theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startadditmenus', get_string('additmenus', 'theme_mb2nl'));
$temp->add($setting);

$name = 'theme_mb2nlchild/secnav';
$title = get_string('secnav', 'theme_mb2nl');
$setting = new admin_setting_configcheckbox($name, $title, '', 1);
$temp->add($setting);

$temp->add(new admin_setting_configmb2spacer('theme_mb2nlchild/additmenussp2'));
...
$temp->add(new admin_setting_configmb2spacer('theme_mb2nlchild/additmenussp3'));
...
$setting = new admin_setting_configmb2end('theme_mb2nlchild/endadditmenus');
$temp->add($setting);
