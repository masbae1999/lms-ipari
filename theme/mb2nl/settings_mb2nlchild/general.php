...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startlogo', get_string('logo', 'theme_mb2nl'));
...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startlayout', get_string('layout', 'theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2spacer('theme_mb2nlchild/logospacer3');
$temp->add($setting);

$name = 'theme_mb2nlchild/tgsdb';
$title = get_string('tgsdb', 'theme_mb2nl');
$setting = new admin_setting_configcheckbox($name, $title, '', 1);
$temp->add($setting);

$name = 'theme_mb2nlchild/tgsdbdef';
...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startheader', get_string('headerstyleheading', 'theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startfrontpage', get_string('frontpage', 'theme_mb2nl'));
$temp->add($setting);
...
$setting = new admin_setting_configmb2start2('theme_mb2nlchild/startfooter', get_string('footer', 'theme_mb2nl'));
$temp->add($setting);
